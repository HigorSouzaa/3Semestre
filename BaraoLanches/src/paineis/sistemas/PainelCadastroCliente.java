...
public class PainelCadastroCliente extends JPanel {
    ...
    private void iniciarComponentes() {
    	...
    	btDeletarCliente.setIcon(new ImageIcon(PainelCadastroCliente.class.getResource("/arquivos/BtDeletarCliente.png")));
		...
		btCadastrar.setIcon(new ImageIcon(PainelCadastroCliente.class.getResource("/arquivos/BtCadastrarCliente.png")));
		...
		btPesquisarCliente.setIcon(new ImageIcon(PainelCadastroCliente.class.getResource("/arquivos/BtPesquisarCliente.png")));
		...
		Label_BackGround.setIcon(new ImageIcon(PainelCadastroCliente.class.getResource("/arquivos/TelaCadastroCliente.png")));
    ...
    private void criarEventos() {
    	...
    	btVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				revalidate();
				repaint();
				PainelAdministracao painelAdministracao = new PainelAdministracao();
				// Adiciona o novo painel a tela
				add(painelAdministracao);
				revalidate();
				repaint();
    ...
    private void criarEventos2() {
    	...
    	btDeletarCliente.addMouseListener(new MouseAdapter() {
    		...
    		public void mouseEntered(MouseEvent e) {
    	    	btDeletarCliente.setIcon(new ImageIcon(PainelCadastroCliente.class.getResource("/arquivos/HoverBtDeletarCliente.png")));
    		}
    		@Override
