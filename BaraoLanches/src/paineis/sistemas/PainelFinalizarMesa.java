...
public class PainelFinalizarMesa extends JPanel {
    ...
    private void initComponents() {
        ...
        add(btFinalizarMesa);
        btFinalizarMesa.setIcon(new ImageIcon(PainelFinalizarMesa.class.getResource("/arquivos/BtFinalizarMesa.png")));
...
//        add(panelMesa);
        ...
        btFechar.setIcon(new ImageIcon(PainelFinalizarMesa.class.getResource("/arquivos/BtFechar.png")));
        ...
        btVisualizarMesa.setIcon(new ImageIcon(PainelFinalizarMesa.class.getResource("/arquivos/BtVisualizarMesa.png")));
        ...
        lblNewLabel.setIcon(new ImageIcon(PainelFinalizarMesa.class.getResource("/arquivos/TelaFinalizarMesa.png")));
    ...
    private void criarEventos2() {
    	btFinalizarMesa.addMouseListener(new MouseAdapter() {
    	    ...
    	    public void mouseEntered(MouseEvent e) {
    	        btFinalizarMesa.setIcon(new ImageIcon(PainelFinalizarMesa.class.getResource("/arquivos/HoverBtFinalizarMesa.png")));
    	    }
    	...
    	btVisualizarMesa.addMouseListener(new MouseAdapter() {
    	    @Override
    	    public void mouseEntered(MouseEvent e) {
    	        btVisualizarMesa.setIcon(new ImageIcon(PainelFinalizarMesa.class.getResource("/arquivos/HoverBtVisualizarMesa.png")));
    	    }
