...
public class PainelCadastroPedido extends JPanel {
    ...
    private void iniciarComponentes() {
        ...
        btFazerPedido.setIcon(new ImageIcon(PainelCadastroPedido.class.getResource("/arquivos/BtFazerPedido.png")));
        ...
        btVoltar.setIcon(new ImageIcon(PainelCadastroPedido.class.getResource("/arquivos/BtVoltar.png")));
        ...
        lblNewLabel.setIcon(new ImageIcon(PainelCadastroPedido.class.getResource("/arquivos/TelaCadastroPedidos.png")));
    ...
    private void criarEventos2() {
        ...
        btFazerPedido.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseEntered(MouseEvent e) {
                btFazerPedido.setIcon(new ImageIcon(PainelCadastroPedido.class.getResource("/arquivos/HoverBtFazerPedido.png")));
        	}
        	@Override
        ...
        btVoltar.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mouseEntered(MouseEvent e) {
                btVoltar.setIcon(new ImageIcon(PainelCadastroPedido.class.getResource("/arquivos/HoverBtVoltar.png")));
        	}
        	@Override
        	public void mouseExited(MouseEvent e) {
                btVoltar.setIcon(new ImageIcon(PainelCadastroPedido.class.getResource("/arquivos/BtVoltar.png")));
